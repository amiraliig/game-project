...
export const GenresSkeleton = () => {
  ...
  return (
    <div className="mx-4 hidden lg:block max-w-sm  border-gray-200 shadow animate-pulse md:p-6 ">
      <h2 className="text-3xl bold font-bold dark:text-white m-2">Genres</h2>
      <ul className="flex flex-col gap-2">
        {arr.map((item, index) => (
          <div className="flex items-center justify-center h-14 mb-4 bg-gray-300 rounded dark:bg-[#9b9b9b41]">
          <svg
          ...
          <div className="h-2.5 bg-gray-200 rounded-full dark:bg-[#9b9b9b41] w-48 mx-2"></div>
